...
static void update() {
    ...
    thickness = 1;
    color = RED;
    text("<", 48.0f + normalized_sinf(ticks * 0.1f) * 2.0f, 50);
    text(">", 52.0f - normalized_sinf(ticks * 0.1f) * 2.0f, 50);
    ...
    if (ant.bar == NULL) {
        ...
        thickness = 2;
        barCenterPosRatio = 0.5f + normalized_sinf(ant.ticks * 0.3f) * 0.4f;
        ...
        thickness = 2;
        barCenterPosRatio = 0.5 + normalized_sinf(ant.ticks * 0.3) * 0.4;
